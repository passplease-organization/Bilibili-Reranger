...
export function setProxyUrl(proxy: string|null): void{
  if(proxy)
    localStorage.setItem(proxyKey,proxy);
...
export function setBackend(url : string|null) :void{
  if(url)
