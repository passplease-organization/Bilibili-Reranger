...
#define INIT_ACCOUNT_NO_SLASH "init-my-account"
#define INIT_ACCOUNT "/" INIT_ACCOUNT_NO_SLASH
#define FEEDBACK_NO_SLASH "feedback"
#define FEEDBACK "/" FEEDBACK_NO_SLASH
